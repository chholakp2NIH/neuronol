...
fpath_mne_raw = Path(
    "~/data/bids/imotions-sample/sub-xx/ses-studyvisit2/eeg/sub-xx_task-all_eeg.fif"
)
fpath_mne_report = Path(
    "~/data/bids/imotions-sample/sub-xx/ses-studyvisit2/eeg/sub-xx_task-all_importreport.html"
)
fpath_headcircum = Path(
    "~/data/bids/imotions-sample/sub-xx/ses-studyvisit2/eeg/sub-xx_desc-manual_headcircumference.json"
)
fpath_dig = Path(
    "~/data/bids/imotions-sample/sub-xx/ses-studyvisit2/eeg/sub-xx_task-all_acq-polhemus_headshape.mat"
)
fpath_restingstate_stimtimes = Path(
    "~/data/bids/imotions-sample/sub-xx/ses-studyvisit2/eeg/sub-xx_task-restingstate_eventsstimtimes.xlsx"
)
